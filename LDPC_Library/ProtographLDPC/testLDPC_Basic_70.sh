...
python3 LDPC-library/make-pchk.py --output-pchk-file myCode.pchk --code-type regular --n-checks 538 --n-bits 768 --checks-per-col 6 --seed 43
...
design=LDPC_768_70  # encoder name
