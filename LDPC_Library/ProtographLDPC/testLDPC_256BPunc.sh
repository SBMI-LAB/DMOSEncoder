...
python3 LDPC-library/make-pchk.py --output-pchk-file myCode.pchk  --code-type regular --n-checks 176 --n-bits 320 --checks-per-col 3 --fraction-transmitted 0.8 --seed 43
...
design=LDPC256B_02  # encoder name
