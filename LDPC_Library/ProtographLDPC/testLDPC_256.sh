...
python3 LDPC-library/make-pchk.py --output-pchk-file myCode.pchk --code-type regular --n-checks 128 --n-bits 256 --checks-per-col 3 --seed 43
...
design=LDPC256_01  # encoder name
