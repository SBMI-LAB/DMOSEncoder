...
python3 LDPC-library/make-pchk.py --output-pchk-file myCode.pchk --code-type protograph --protograph-file sample-protographs/ar4ja_n_0_rate_1_2  --expansion-factor 192  --seed 43
...
design=LDPC_768_1_2  # encoder name
