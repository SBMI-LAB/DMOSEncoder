...
python3 LDPC-library/make-pchk.py --output-pchk-file myCode.pchk  --code-type regular --n-checks 160 --n-bits 640 --checks-per-col 3 --fraction-transmitted 0.8 --seed 43
