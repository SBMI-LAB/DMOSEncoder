...
python3 LDPC-library/make-pchk.py --output-pchk-file myCode.pchk --code-type protograph --protograph-file sample-protographs/ar4ja_n_2_rate_3_4  --expansion-factor 96  --seed 43
...
design=LDPC_768_3_4  # encoder name
